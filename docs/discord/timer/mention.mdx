...
| <Mention>@everyone</Mention><br/><Mention>@here</Mention> | タイマーをセットしたメンバーが`@everyone、@here、全てのロールにメンション`の権限を持っている場合されます。<br/>![](../../assets/permissions/mention-everyone-here-and-all-roles.png)                                                                                                                         |
| <Mention>@ロール</Mention>                                   | タイマーをセットしたメンバーが`@everyone、@here、全てのロールにメンション`の権限を持っている場合、<br/>![](../../assets/permissions/mention-everyone-here-and-all-roles.png)<br/>または、ロールに`このロールに対して@mentionを許可する`が設定されている場合されます。<br/>![](../../assets/permissions/allow-anyone-to-mention-this-role.png) |
...
| 優先度 | 設定場所  | 対象            | 画像                                                       |
|-----|-------|---------------|----------------------------------------------------------|
| 高   | チャンネル | メンバー(許可)      | ![](../../assets/permissions/channel-member-allow.png)   |
|     | チャンネル | メンバー(拒否)      | ![](../../assets/permissions/channel-member-deny.png)    |
|     | チャンネル | ロール(許可)       | ![](../../assets/permissions/channel-role-allow.png)     |
|     | チャンネル | ロール(拒否)       | ![](../../assets/permissions/channel-role-deny.png)      |
|     | チャンネル | @everyone(許可) | ![](../../assets/permissions/channel-everyone-allow.png) |
|     | チャンネル | @everyone(拒否) | ![](../../assets/permissions/channel-everyone-deny.png)  |
|     | サーバー  | ロール	          | ![](../../assets/permissions/server-role-allow.png)      |
| 低   | サーバー  | @everyone	    | ![](../../assets/permissions/server-everyone-allow.png)  |