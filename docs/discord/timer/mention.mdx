...
| 優先度 | 設定場所  | 対象            | 画像                                                       |
|-----|-------|---------------|----------------------------------------------------------|
| 高   | チャンネル | メンバー(許可)      | ![](../../assets/permissions/channel-member-allow.jpg)   |
|     | チャンネル | メンバー(拒否)      | ![](../../assets/permissions/channel-member-deny.jpg)    |
|     | チャンネル | ロール(許可)       | ![](../../assets/permissions/channel-role-allow.jpg)     |
|     | チャンネル | ロール(拒否)       | ![](../../assets/permissions/channel-role-deny.jpg)      |
|     | チャンネル | @everyone(許可) | ![](../../assets/permissions/channel-everyone-allow.jpg) |
|     | チャンネル | @everyone(拒否) | ![](../../assets/permissions/channel-everyone-deny.jpg)  |
|     | サーバー  | ロール	          | ![](../../assets/permissions/server-role-allow.jpg)      |
| 低   | サーバー  | @everyone	    | ![](../../assets/permissions/server-everyone-allow.jpg)  |