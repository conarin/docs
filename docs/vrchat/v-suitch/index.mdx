---
title: v-suitch
description: VRChatでExpression MenuからSwitchBotデバイスを操作するやつ。
---
import {TwitterTweetEmbed} from "react-twitter-embed";

<Button to='https://redirect.conarin.com/github/v-suitch' style='success'>リポジトリはこちら</Button>

<TwitterTweetEmbed
    tweetId={'1799399401728975317'}
